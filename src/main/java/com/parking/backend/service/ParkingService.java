...
public class ParkingService {
    ...
    ParkingService(ParkingRepository parkingRepository, BookingRepository bookingRepository,
    ...
    public List<Parking> getAllParkings(int page, int size) { // User App (Home m1 + details m1 + map m1 + explorer m1)
                                                              // + Guard App (parking selection m1 + walkin screen m1)
