...
public interface BookingRepository extends MongoRepository<Booking, String> {
        ...
        Optional<Booking> findTopByVehicleNumberAndStatus(String vehicleNumber, String status);
        ...
        List<Booking> findByVehicleNumberAndStatusIn(String vehicleNumber, List<String> statuses);
